...
import {
  ...
  LinearProgress,
  Table,
  TableHead,TableRow, TableCell, TableBody, makeStyles, Tab
...
import { numberWithCommas } from "../Components/Banner/Courasel";
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <Container style={{ textAlign: "center" }}>
        <Typography
          variant="h3"
          style={{ margin: 18, fontFamily: "Montserrat", fontWeight: "bolder" }}
        >
        ...
        :
        (<Table>
            <TableHead style={{backgroundColor:"#00ffe4" , fontWeight:'bolder'}}>
             <TableRow>
                ...
                {handleSearch().slice((page-1)*20,(page-1)*20+20).map(row=>{
                  ...
                  return (
                    ...
                    >
                      ...
                      {symbol}{" "} {numberWithCommas(row?.current_price.toFixed(2))}</TableCell>

                      <TableCell align="right" style={{color:profit>0?"rgb(14,203,129)":"red",fontSize:"17"}}>{profit && "+"}
